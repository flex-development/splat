...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/splat
   cd splat
   ```
...
```sh
https://github.com/flex-development/splat/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/splat/discussions/new?category=q-a
